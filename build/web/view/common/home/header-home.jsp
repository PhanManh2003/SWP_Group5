                                        ...
                                        <ul class="sub-menu mega-menu">
                                            ...
                                            <li>
                                                <div class="mega-menu-img">
                                                    <a href="courses.html"><img src="${pageContext.request.contextPath}/assets/img/others/mega_menu_img.jpg" alt="img"></a>
                                                </div>
                                            </li>
                                        </ul>
                                    </li>
                            ...
                            <div class="tgmenu__action">
                                <ul class="list-wrap">
                                    ...
                                    <li class="header-btn login-btn">
                                        <a href="${pageContext.request.contextPath}/authen?action=login">Log in</a>
                                    </li>
                                </ul>
                            </div>
