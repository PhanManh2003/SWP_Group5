...
<jsp:include page="../../commonAdmin/head.jsp"></jsp:include>
    ...
    <table class="table table-bordered" id="lessionTable">
        ...
        <tbody>
            <c:forEach var="semester" items="${semesters}">
                <tr>
                    ...
                    <td>
                        <span class="${semester.canDelete ? 'badge badge-success' : 'badge badge-danger'}">
                            ${semester.canDelete ? "Yes" : "No"}
                        </span>
                    </td>
                    <td>${semester.admin != null ? semester.admin.name : "N/A"}</td>
                    <td>
