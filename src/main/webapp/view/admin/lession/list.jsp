...
<jsp:include page="../../commonAdmin/head.jsp"></jsp:include>
    ...
    <a href="lessons?action=new" class="btn btn-primary mb-3">Add New Lesson</a>
            ...
            <c:forEach var="lession" items="${listLession}">
                <tr>
                    ...
                    <td>
                     ...
                     <td>${lession.admin != null ? lession.admin.name : "N/A"}</td>
                    <td>
                        <a href="lessons?action=edit&id=${lession.lessionId}" class="btn btn-warning btn-sm">Edit</a>
        ...
        <script>
                            ...
                            function confirmDelete(lessionId) {
                                if (confirm("Are you sure you want to delete this lesson?")) {
                                    window.location.href = 'lessons?action=delete&id=' + lessionId;
                                }
                            }
        </script>
        </tbody>
