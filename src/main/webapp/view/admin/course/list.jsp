...
<jsp:include page="../../commonAdmin/head.jsp"></jsp:include>
        <div class="container">
            ...
            <table class="table table-striped" id="lessionTable">
                ...
                <tbody>
                    <c:forEach var="course" items="${courses}">
                        <tr>
                            ...
                            <td>
                        <span class="${course.canDelete ? 'badge badge-success' : 'badge badge-danger'}">
                            ${course.canDelete ? "Yes" : "No"}
                        </span>
                    </td>
                     <td>${course.admin != null ? course.admin.name : "N/A"}</td>
                            <td>
