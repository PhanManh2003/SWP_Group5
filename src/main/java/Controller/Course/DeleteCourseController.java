...
public class DeleteCourseController extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        if (result > 0) {
            response.sendRedirect("ListCourseController?success=Delete successfully");
        } else {
            response.sendRedirect("ListCourseController?error=Delete fail. Course have a object reference to.");
        }
    }
