...
public class DeleteStudentController extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        if (student != null) {
            ...
            if (result > 0) {
                response.sendRedirect("ListStudentsController?success=Delete successfully");
            } else {
                response.sendRedirect("ListStudentsController?error=Delete fail. Student have a object reference to");
            }
        } else {
